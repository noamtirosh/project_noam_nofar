...
import torch
from train_model.conv_count_train import Classifier
import numpy as np
...
model = Classifier()
side_to_use = LEFT_SIDE
flip_side_flag = False # right side
set_side_flag = False
#init model
model_path = r"C:\git_repos\project_noam_nofar\train_model\conv_count_with_err.pth"
...
video_path = r"C:\Users\noam\Downloads\Nofar_test_left.mp4"
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose_origen:
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose_side:
        ...
        while cap.isOpened():
            ...
            print("state :{} with - {}%".format(top_class,top_p))
